    ...
    branch_end_2:;
    {
        ...
        }
        {
...

            {
                ...
                tmp_dircall_arg2_1 = impl___main__$$$function__18_complex_call_helper_dict_unpacking_checks(tstate, dir_call_args);
            }
...

            {
                ...
                tmp_assign_source_3 = impl___main__$$$function__12_complex_call_helper_star_dict(tstate, dir_call_args);
            }
            if (tmp_assign_source_3 == NULL) {
                assert(HAS_ERROR_OCCURRED(tstate));
...
static PyObject *impl_pandas$core$window$ewm$$$function__14___init__(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    // Framed code:
    {
...

        {
            ...
            tmp_call_result_1 = impl___main__$$$function__15_complex_call_helper_pos_keywords_star_list_star_dict(tstate, dir_call_args);
        }
        if (tmp_call_result_1 == NULL) {
            assert(HAS_ERROR_OCCURRED(tstate));
